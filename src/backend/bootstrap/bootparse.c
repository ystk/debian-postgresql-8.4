...
static const yytype_uint16 yyrline[] =
{
     ...
     238,   237,   259,   282,   305,   315,   325,   326,   330,   343,
     344,   348,   349,   353,   354,   358,   359,   363,   372,   376,
     377,   381,   382,   383,   387,   389,   391,   396,   400
};
#endif
...
#line 260 "bootparse.y"
    {
					...
					relationId = RangeVarGetRelid(makeRangeVar(NULL, LexIDStr((yyvsp[(6) - (11)].ival)), -1),
												  false);
...
#line 283 "bootparse.y"
    {
					...
					relationId = RangeVarGetRelid(makeRangeVar(NULL, LexIDStr((yyvsp[(7) - (12)].ival)), -1),
												  false);
